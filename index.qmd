---
title: "Isaac Baron" # change this to your name
image: images/headshot.jpg # change to your profile pic
about:  
  template: trestles # templates: jolla, trestles, solana, marquee, broadside
  links: 
    - icon: envelope
      text: Contact Me
      href: mailto:ibaron01@hamline.edu # change to your email
    - icon: linkedin
      href: https://www.linkedin.com/in/isaacbaron/ # change to your linkedin address
    - icon: github
      href: https://github.com/isaacedubaron # change to your github address
    - icon: twitter
